        ...
        <div class="row page-titles">
            <div class="col-md-6 col-8 align-self-center">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Add Vacancy Section</li>
                </ol>
            </div>
        </div>
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-6">
                                <h4 class="card-title">Add Vacancy Form</h4>
                            </div>
                            <div class="col-md-6">
                        ...
                        <form @submit.prevent="addVacancy" class="mt-4">
...
export default {
    ...
    methods: {
        addVacancy(){
            this.$Progress.start()
            this.form.post('api/recruitment/add/vacancy')
            .then(res => {
